...
extension CategoryModelQueryFilter
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
  iconDataEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
  iconDataMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByIconData() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByIsExpense() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByIconData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconData', Sort.asc);
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByIsExpense() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isExpense', Sort.asc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByIconData({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByIsExpense() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, String, QQueryOperations> iconDataProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'iconData');
    });
  }

  QueryBuilder<CategoryModel, bool, QQueryOperations> isExpenseProperty() {
    return QueryBuilder.apply(this, (query) {
